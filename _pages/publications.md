...
<div class="col-md-10 col-sm-12 col-xs-12">
 ...
 {{ publi.authors | replace_first: 'M. H. Arshad', '<b>M. H. Arshad</b>'}}<br/>
 {% if publi.journal %}Under review at <i>{{ publi.journal }}</i>,{% endif %} {% if publi.arxiv %} TechRxiv {{ publi.arxiv }}{% endif %}<br/>
 ...
 {% if publi.arxiv %}<a href="https://www.techrxiv.org/articles/preprint/{{ publi.arxiv }}" target="_blank"><button class="btn btn-sm btn-primary">TECHRXIV</button></a> {% endif %}
